...
class EditButton extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = { showModal: false, courses: this.props.user.courses, languages: this.props.user.languages };
  }
  ...
  render() {
    return (
      <>
        <img
          className="editIcon"
          src={require("../../images/edit-icon.png")}
          onClick={() => this.setState({ ...this.state, showModal: true })}
        ></img>
        <Modal show={this.state.showModal} onHide={() => this.setState({ ...this.state, showModal: false })} animation={false} centered>
          ...
          <Modal.Body>
            <Form>
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  defaultValue={props.user.imgPath}
                  id="imgInput"
                />
              </Form.Group>
              ...
              <div className="myAddInputRow">
                ...
                <Form.Control
                  type="text"
                  defaultValue={props.user.social.linkedin}
                  id="linkedinInput"
                />
              </div>
              <div className="myAddInputRow">
              ...
              <div className="myAddInputRow">
                ...
                <Form.Control
                  type="text"
                  defaultValue={props.user.social.facebook}
                  id="facebookInput"
                />
              </div>
              <div className="myAddInputRow">
                ...
                <Form.Control
                  type="text"
                  defaultValue={props.user.social.instagram}
                  id="instagramInput"
                />
              </div>
              <div className="myAddInputRow">
                ...
                <Form.Control
                  type="text"
                  defaultValue={props.user.social.youtube}
                  id="youtubeInput"
                />
              </div>
            </Form>
